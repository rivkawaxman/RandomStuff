...
namespace WindowsFormsApplication1.PracticeDataSetTableAdapters {
...
SELECT BusinessEntityID, NationalIDNumber, LoginID, OrganizationNode, OrganizationLevel, JobTitle, BirthDate, MaritalStatus, Gender, HireDate, SalariedFlag, VacationHours, SickLeaveHours, CurrentFlag, rowguid, ModifiedDate FROM HumanResources.Employee WHERE (BusinessEntityID = @BusinessEntityID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT * FROM HumanResources.Employee where gender like \'F\'";
        ...
        public virtual int Fill(PracticeDataSet.EmployeeDataTable dataTable) {
        ...
        public virtual PracticeDataSet.EmployeeDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            PracticeDataSet.EmployeeDataTable dataTable = new PracticeDataSet.EmployeeDataTable();
        ...
        public virtual int FillBy(PracticeDataSet.EmployeeDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(PracticeDataSet.EmployeeDataTable dataTable) {
